...
import com.example.fa_amandeep_c0850554_android.databinding.ActivityViewFavoritePlaceBinding;
...
public class ViewFavoritePlaceActivity extends FragmentActivity implements OnMapReadyCallback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.butNormal.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mMap.setMapType(GoogleMap.MAP_TYPE_NORMAL);
            }
        });
        binding.butSatellite.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mMap.setMapType(GoogleMap.MAP_TYPE_SATELLITE);
            }
        });
        binding.butHybrid.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
