...
import com.example.fa_amandeep_c0850554_android.databinding.ActivityFavoritePlaceMapBinding;
...
//    private ActivityAddorUpdateFavoritePlace binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.buttNormal.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mMap.setMapType(GoogleMap.MAP_TYPE_NORMAL);
            }
        });
        binding.buttSattelite.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mMap.setMapType(GoogleMap.MAP_TYPE_SATELLITE);
            }
        });
        binding.buttHybrid.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
